...
def download_scotus_case_audio():
    ...
    The function reads a CSV file containing case IDs and iterates over each row.
    For each case, it creates a directory for the case if it doesn't exist and
    downloads the corresponding audio file using curl command. If the file already
    exists, it skips downloading.
